...
class TrainingTab:
    ...
    def refresh_ui(self):
        ...
        elif self.train_config.model_type.is_nanosaur():
            self.__setup_nanosaur_ui(column_0, column_1, column_2)
    ...
    def __setup_nanosaur_ui(self, column_0, column_1, column_2):
        self.__create_base_frame(column_0, 0)
        self.__create_text_encoder_frame(column_0, 1, supports_clip_skip=False)
