...
class BaseOptimizerParamsWindowView:
    ...
    def build_dynamic_content(self, master, controller, optimizer_ui_state,
        ...
        KEY_DETAIL_MAP = {
            ...
            'snr_cond': {'title': 'SNR Precondition', 'tooltip': 'Applies a Signal-to-Noise Ratio (SNR) precondition to reshape the optimization curve. It prioritizes high-confidence signals and dampens noise. On-the-fly math with zero memory overhead. Requires Normalization-then-Momentum (NtM). ', 'type': 'bool'},
